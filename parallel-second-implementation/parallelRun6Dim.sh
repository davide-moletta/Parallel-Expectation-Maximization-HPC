...
# arguments are                     executable                                   N     D  K iter filepath
mpiexec -n 16 expectation-maximization/parallel-second-implementation/parallelRun 20000 6 4 200 "expectation-maximization/data-generator/N20000_K4_D6.csv"
...
# arguments are                     executable                                   N       D K iter filepath
mpiexec -n 32 expectation-maximization/parallel-second-implementation/parallelRun 20000 6 4 200 "expectation-maximization/data-generator/N20000_K4_D6.csv"
...
# arguments are                      executable                                  N       D K iter filepath
mpiexec -n 64 expectation-maximization/parallel-second-implementation/parallelRun 20000 6 4 200 "expectation-maximization/data-generator/N20000_K4_D6.csv"
